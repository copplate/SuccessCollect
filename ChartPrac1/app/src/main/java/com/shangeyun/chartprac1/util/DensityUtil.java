package com.shangeyun.chartprac1.util;
...
import com.shangeyun.chartprac1.app.MyApplicaion;
...
public class DensityUtil {
    ...
    /**
     * 根据手机的分辨率从 px(像素) 的单位 转成为 dp,float格式
     */
    public static float px2fdp(Context context, float pxValue) {
        final float scale = getDpScale(context);
