...
public class WithNumberFragment extends Fragment implements LifecycleObserver {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("tiktok", "onCreateView: ------WithNumberFragment----------" + number + sign);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("tiktok", "onClick: ------WithNumberFragment-------" + "btnClick" + "   " + number + sign);
            }
        });

        Log.d("tiktok", "onViewCreated: -----WithNumberFragment-----" + number + sign);
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.d("tiktok", "onStop: ------WithNumberFragment-----" + number + sign);
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.d("tiktok", "onResume: ----WithNumberFragment---------"+ number + sign);
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.d("tiktok", "onDestroyView: -------WithNumberFragment-------"+ number + sign);
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.d("tiktok", "onPause: ------WithNumberFragment--------"+ number + sign);
    }
