...
import com.example.cachecountviewpager2.lifecycle.MyObserver;
...
public class WithVp2Fragment extends Fragment {
    ...
    private WithNumberFragment withVp2Fragment0;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        withVp2Fragment0 = new WithNumberFragment(0, "WithVp2Fragment");
        ...
        getViewLifecycleOwner().getLifecycle().addObserver(withVp2Fragment0);
        ...
        fragmentList.add(withVp2Fragment0);
